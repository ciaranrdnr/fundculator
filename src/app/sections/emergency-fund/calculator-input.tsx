  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex justify-between w-full items-center">
        <p className="text-base capitalize font-medium">{title}</p>
        <div className="border px-4 py-2 rounded-lg focus-within:border-grey-10 min-w-fit">
          <input
              ...
              {Array.from({
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <p className="absolute bottom-0 translate-y-5 text-grey-25">
                      {showNumber
                        ? isMoney
                          ? moneyDot(number)
                          : number.toFixed(0)
